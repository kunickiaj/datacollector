 ...
 */
package com.streamsets.pipeline.lib.parser.tcp.syslog;
...
import com.streamsets.pipeline.lib.parser.udp.syslog.Errors;
...
public class SyslogParser extends AbstractParser {
  ...
  @Override
  public List<Record> parse(ByteBuf buf) throws OnRecordErrorException {
